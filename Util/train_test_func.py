...
def predict_full_volume(img, data_shape, label_shape, data_channel, class_num,batch_size, sess, proby, x):
    '''
    ...
    temp_prob = volume_prediction(img, new_data_shape, new_label_shape, data_channel, class_num, batch_size, sess,
                                  proby, x)
    return temp_prob


def volume_prediction(img, data_shape, label_shape, data_channel, class_num, batch_size, sess, proby, x):
    '''
